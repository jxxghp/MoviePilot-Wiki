...
> 插件如何支持V2版本请看 [这里](https://github.com/jxxghp/MoviePilot-Plugins/blob/main/docs/V2_Plugin_Development.md)。使用媒体识别、搜索、订阅、下载、整理、刮削、媒体库事件或宿主 API 的插件，还需要查看 [V3 插件适配指引](/plugin-v3-adaptation)。
{.is-success}
